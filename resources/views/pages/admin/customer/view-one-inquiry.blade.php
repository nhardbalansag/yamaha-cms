    ...
    <div class="p-4 card card-primary card-outline">
      ...
      <div class="p-0 card-body">
        <div class="pt-4 mailbox-read-info">
          ...
          <h6>From: {{ $inquiries[0]->email_address }}
            <span class="float-right mailbox-read-time">{{ date($inquiries[0]->created_at )}}</span></h6>
        </div>
        <!-- /.mailbox-read-info -->
        ...
        <ul class="clearfix mailbox-attachments d-flex align-items-stretch">
          ...
          <li>
            <span class="mailbox-attachment-icon has-img">
                <img class="w-20" src="{{asset('storage/' . $productinfo[0]->photo_path) }}" alt="Attachment">
            </span>

            <div class="mailbox-attachment-info">
                <a href="{{asset('storage/' . $productinfo[0]->photo_path) }}" class="text-black mailbox-attachment-name">
                    ...
                    {{ $productinfo[0]->title }}.jpg
                </a>
                <span class="clearfix mt-1 mailbox-attachment-size">
                    <span>2.67 MB</span>
                    <a href="{{asset('storage/' . $productinfo[0]->photo_path) }}" class="float-right btn btn-default btn-sm">
