...
<div class="my-3 p-3 bg-white rounded shadow-sm">
    ...
    <div class="media text-muted pt-3">
        <div class="flex-shrink-0 h-20 w-20 mx-2 border-solid border-2 border-gray-600">
            <img class="h-full w-full " src="{{URL('/storage/profile-photos/OprKr9ib3f8ARM9yjHIWwxEZFhjussM3XAFh2Fyo.jpeg')}}" alt="">
        </div>
