<div class=" shadow p-4 m-4 sm:mt-0">
    <div class="">
        <div class="md:col-span-1">
            <div class="sm:px-0">
                <h3 class="text-lg font-medium leading-6 text-gray-900 capitalize"> Color </h3>
                <p class="mt-1 text-sm leading-5 text-gray-600 capitalize">
                    add your product color
                </p>
            </div>
        </div>  
        ...
        <form wire:submit.prevent="createColor" enctype="multipart/form-data">
