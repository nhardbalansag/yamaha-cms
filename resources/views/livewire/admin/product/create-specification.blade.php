            ...
            <div class="sm:rounded-md sm:overflow-hidden">
                <div class="">
                    ...
                    <div class="w-1/2 mb-4">
                        ...
                        <input wire:model.defer='title' id="company_website" class="flex-1 block w-full text-lg transition duration-150 ease-in-out rounded-none form-input rounded-r-md ">
                        </div>
