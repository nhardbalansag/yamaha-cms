            ...
            <div class="sm:rounded-md sm:overflow-hidden">
                <div class="">
                    <div class="w-1/2 mb-4">
                        ...
                        <select wire:model.prevent ="specification_category_id" id="country" class="block w-full px-3 py-2 mt-1 text-lg transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md shadow-sm form-select focus:outline-none focus:shadow-outline-blue focus:border-blue-300 ">
                            ...
                            @error('specification_category_id') <span class="text-red-600 error">{{ $message }}</span> @enderror
                    </div>
                    <div class="w-1/2 mb-4">
                        ...
                        <input wire:model='title' id="company_website" class="flex-1 block w-full text-lg transition duration-150 ease-in-out rounded-none form-input rounded-r-md ">
                        </div>
                    ...
                    <div class="w-3/4">
                        ...
                        <div class="rounded-md shadow-sm">
                            <textarea wire:model="description" id="about" rows="3" class="block w-full mt-1 transition duration-150 ease-in-out form-textarea sm:text-sm sm:leading-5" placeholder="description here"></textarea>
                        </div>
                    ...
                    <div class="w-1/4">
                        ...
                        <select wire:model.prevent ="status" id="country" class="block w-full px-3 py-2 mt-1 text-lg transition duration-150 ease-in-out bg-white border border-gray-300 rounded-md shadow-sm form-select focus:outline-none focus:shadow-outline-blue focus:border-blue-300">
                ...
                <div class="px-4 text-right py-30 sm:px-6 ">
                    <span class="inline-flex rounded-md shadow-sm">
                        <button class="btn btn-dark">Add Specification</button>
                    </span>
                </div>
            </div>
        </form>
